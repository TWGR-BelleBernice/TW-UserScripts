      ...
      init: function () {
        ...
        this.data.custom = TWDB.Settings.get("custom", {
          ...
          4: {
            id: 4,
            type: "fort",
            para: { att: 200, def: 20, health: 100, type: 0 },
            name: "Fortbattle Attacker (Att)",
          },
          5: {
            id: 5,
            type: "fort",
            para: { att: 20, def: 200, health: 100, type: 0 },
            name: "Fortbattle Attacker (Def)",
          },
          6: {
            id: 6,
            type: "fort",
            para: { att: 200, def: 20, health: 100, type: 1 },
            name: "Fortbattle Defender (Att)",
          },
          7: {
            id: 7,
            type: "fort",
            para: { att: 20, def: 200, health: 100, type: 1 },
            name: "Fortbattle Defender (Def)",
          },
          8: {
            id: 8,
            type: "duel",
            para: { 12: 1, 15: 1, 16: 1, 24: 1 },
            name: "Range Dueler (Att)",
          },
          9: {
            id: 9,
            type: "duel",
            para: { 12: 1, 15: 1, 16: 1, 21: 1 },
            name: "Range Dueler (Def)",
          },
          10: {
            id: 10,
            type: "duel",
            para: { 6: 1, 7: 1, 11: 1, 15: 1 },
            name: "Melee Dueler",
          },
        });
                  ...
                  var i,
                    ...
                    o =
                      Character.charClass === "soldier"
                        ? Premium.hasBonus("character")
                          ? 1.5
                          : 1.25
                        : 1,
                    u =
                      Character.charClass == "worker"
                        ? Premium.hasBonus("character")
                          ? 1.4
                          : 1.2
                        : 1,
                    a =
                      (Number(t.boni.other[11]) || 0) +
                      (Number(t.boni.other[17]) || 0),
                    f =
                      (Number(t.boni.other[12]) || 0) +
                      (Number(t.boni.other[18]) || 0);
                  if (t.para.type === 0) {
                    s.aim =
                      CharacterSkills.skills.aim.points +
                      (typeof t.boni.skill[3] !== "undefined"
                        ? t.boni.skill[3]
                        : 0) +
                      (typeof t.boni.skill[15] !== "undefined"
                        ? t.boni.skill[15]
                        : 0);
                    s.hide =
                      CharacterSkills.skills.hide.points +
                      (typeof t.boni.skill[2] !== "undefined"
                        ? t.boni.skill[2]
                        : 0) +
                      (typeof t.boni.skill[13] !== "undefined"
                        ? t.boni.skill[13]
                        : 0);
                    s.dodge =
                      CharacterSkills.skills.dodge.points +
                      (typeof t.boni.skill[2] !== "undefined"
                        ? t.boni.skill[2]
                        : 0) +
                      (typeof t.boni.skill[12] !== "undefined"
                        ? t.boni.skill[12]
                        : 0);
                    s.leadership =
                      CharacterSkills.skills.leadership.points +
                      (typeof t.boni.skill[4] !== "undefined"
                        ? t.boni.skill[4]
                        : 0) +
                      (typeof t.boni.skill[20] !== "undefined"
                        ? t.boni.skill[20]
                        : 0);
                    s.health =
                      CharacterSkills.skills.health.points +
                      (typeof t.boni.skill[1] !== "undefined"
                        ? t.boni.skill[1]
                        : 0) +
                      (typeof t.boni.skill[9] !== "undefined"
                        ? t.boni.skill[9]
                        : 0);
                    i =
                      100 +
                      (Character.level - 1) *
                        Character.lifePointPerHealthSkill +
                      s.health *
                        (Character.lifePointPerHealthSkill +
                          Character.lifePointPerHealthSkillBonus) +
                      " | ";
                    i +=
                      Number(
                        (25 +
                          Math.pow(s.leadership * o, 0.5) +
                          Math.pow(s.aim, 0.5) +
                          Math.pow(s.hide, 0.6) +
                          a) *
                          u,
                    ...
                    s.aim =
                      ...
                      (typeof t.boni.skill[15] !== "undefined"
                        ...
                        : 0);
                    s.pitfall =
                      CharacterSkills.skills.pitfall.points +
                      (typeof t.boni.skill[3] !== "undefined"
                        ? t.boni.skill[3]
                        : 0) +
                      (typeof t.boni.skill[17] !== "undefined"
                        ? t.boni.skill[17]
                        : 0);
                    s.dodge =
                      CharacterSkills.skills.dodge.points +
                ...
                case "duel":
                  ...
                  for (l in t.para) {
                    ...
                    if (typeof TWDB.ClothCalc._id2skill[l] !== "undefined") {
                      ...
                      if (
                        typeof CharacterSkills.skills[
                          TWDB.ClothCalc._id2skill[l]
                        ] !== "undefined"
                      ) {
                        i +=
                          CharacterSkills.skills[TWDB.ClothCalc._id2skill[l]]
                            .points;
                      } else if (
                        typeof CharacterSkills.attributes[
                          TWDB.ClothCalc._id2skill[l]
                        ] !== "undefined"
                      ) {
                        i +=
    ...
    (function ($) {
        ...
        var o = function () {
          ...
          var s = [
            ...
            [
              0,
              "noshopsale",
              "Απενεργοποίηση της ειδοποίησης για ΠΩΛΗΣΗ&nbsp;-&nbsp;[Κάτω από το άβαταρ]",
              false,
            ],
            [
              0,
            ...
            [
              0,
              "forumlastpage",
              "Προσθήκη ενός κουμιού για την μετάβαση στην τελευταία ανάρτηση του Φόρουμ Πόλης",
              false,
            ],
      ...
      var Forum = (function (e) {
        ...
        var i = function (t) {
          ...
          if (
            n.find("#thread_overview").length == 1 &&
            n.find(".twdb_lastpost").length == 0
          ) {
            n.find(".row").each(function (t) {
              ...
              e(this)
                ...
                .append(
                  '<img src="' +
                    TWDB.images.lastpost +
                    '" class="twdb_lastpost" style="position:absolute;cursor:pointer;margin-left:3px;" onclick="Forum.openThread(' +
                    r +
                    ", " +
                    n +
                    ')"></img>',
